...
Page({
  ...
  getGameList: function (gid) {
    ...
    App._post_form('order/getHeldOrderList', { user_token: App.getGlobalData('user_token'), gid: _this.data.gid, limit: _this.data.num, page: _this.data.page}, function (result) {
      console.log(result);
